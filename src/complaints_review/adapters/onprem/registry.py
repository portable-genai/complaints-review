...
profile this port binds to the A2A AgentCard registry adapter (or A3); switching
...
adapter, so the contract tests prove interface parity. Porting the agent registry to an
on-premise catalog is *only* a matter of filling these bodies in : the domain is
unchanged.
"""
