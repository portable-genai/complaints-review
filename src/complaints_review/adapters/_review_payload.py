...
customer identifier reaches Hrz7 over the wire; Hrz7 redacts again before its own audit write
(defense in depth). The maker (the reviewer/assistant that originated the review) and the tenant
are asserted here and trusted by Hrz7 because this is an authenticated S2S caller (per-hop OBO is
...
def review_to_review(review: ComplaintReview, *, maker: str, tenant: str = "") -> Review:
    """Build the review a producer submits to Hrz7 when a complaint review escalates."""
