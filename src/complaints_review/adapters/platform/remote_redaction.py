...
implements :class:`PIIRedactionPort` and is mandatory for B6 (rule R1): customer
complaint PII is removed at the boundary before any model, index or audit call (P-04).
...
class RemoteRedactionError(ComplaintsError):
