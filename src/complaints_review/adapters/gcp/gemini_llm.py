...
(system instruction, temperature, max-output-tokens, a :class:`ThinkingConfig` whose
level is mapped from ``request.thinking``, and structured-output config when a response
schema is supplied), and maps ``usage_metadata`` back onto :class:`TokenUsage`.
