...
``complaints-review-audit`` log to a **locked log bucket** (WORM, ~7-year retention), so
review records are write-once and immutable (the regulator-grade audit guarantee).
