...
blocks the malicious test input (``sample_complaints.MALICIOUS_COMPLAINT``) and allows a
benign complaint, so the blocked-path tests pass by feeding malicious vs benign text
rather than by swapping in a special fake. There is no Google emulator for Model Armor,
