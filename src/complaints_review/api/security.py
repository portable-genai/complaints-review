...
def get_principal(request: Request) -> Principal:
    ...
    try:
        # Binding the adapter is inside the try on purpose: the seeded-persona adapter
        # REFUSES to construct when the local profile was inherited rather than chosen, and
        # "this request cannot be authenticated" is a 401, not a 500.
